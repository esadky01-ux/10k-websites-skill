  ...
  return (
    <div className={className}>
      <button
        ...
        className="group flex min-h-11 w-full items-center gap-3 rounded-md py-2.5 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-taxi-ink focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
      >
        <span
          aria-hidden="true"
          className={`relative inline-flex h-7 w-12 shrink-0 items-center rounded-full border transition-colors motion-reduce:transition-none ${
            checked ? "border-taxi-ink bg-taxi" : "border-line-strong bg-surface-2 group-hover:border-muted"
          }`}
        >
          <span
            className={`inline-block h-5 w-5 rounded-full transition-transform motion-reduce:transition-none ${
              checked ? "translate-x-6 bg-surface" : "translate-x-1 bg-muted"
            }`}
          />
        </span>
