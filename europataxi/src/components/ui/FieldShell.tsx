  ...
  return (
    <div className={className}>
      ...
      {error ? (
        ...
        <p id={`${id}-error`} className="mt-1.5 flex items-start gap-1.5 text-sm font-medium text-taxi-ink" aria-live="polite">
...
export const controlClasses =
  "block w-full rounded-md border border-line-strong bg-surface px-3.5 text-base text-content placeholder:text-muted transition-colors motion-reduce:transition-none hover:border-muted focus:border-taxi-ink focus:outline-none focus:ring-2 focus:ring-taxi-ink-ink/40 disabled:cursor-not-allowed disabled:opacity-50 aria-[invalid=true]:border-taxi-ink";
