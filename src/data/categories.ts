...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image: "/media/categories/diepvries.jpg",
  },
  {
    slug: "conserven",
    name: { nl: "Conserven & Pickles", tr: "Konserve & Turşu" },
    shortName: { nl: "Conserven", tr: "Konserve" },
    description: {
      nl: "Gepelde tomaten, pizzasaus, jalapeños, Griekse pepers, artisjok, tonijn, ansjovis, kappertjes en ingelegde groenten. De basisconserven voor pizza en döner.",
    ...
    image: "/media/categories/conserven.jpg",
  },
  {
    slug: "kaas-zuivel",
    ...
    image: "/media/categories/kaas-zuivel.jpg",
  },
  {
    slug: "brood-deeg",
    ...
    image: "/media/categories/brood-deeg.jpg",
  },
  {
    slug: "droge-voeding",
    ...
    image: "/media/categories/droge-voeding.jpg",
  },
  {
    slug: "dranken",
    ...
    image: "/media/categories/dranken.jpg",
  },
  {
    slug: "ambalaj",
