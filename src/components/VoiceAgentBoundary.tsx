...
export default class VoiceAgentBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="notranslate fixed bottom-4 end-4 z-[45] w-[min(92vw,360px)] rounded-2xl border border-cream-200 bg-white px-4 py-3 text-sm text-ink-800 shadow-2xl" translate="no" role="alert" data-testid="voice-boundary">
